...
public class CompanyAdapter$ViewHolder_ViewBinding<T extends CompanyAdapter.ViewHolder> implements Unbinder {
  protected T target;

  public CompanyAdapter$ViewHolder_ViewBinding(T target, Finder finder, Object source) {
    this.target = target;
