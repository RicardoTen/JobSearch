...
public class SendLocationHolder_ViewBinding<T extends SendLocationHolder> implements Unbinder {
  ...
  public SendLocationHolder_ViewBinding(T target, Finder finder, Object source) {
    this.target = target;
    ...
    target.layout_location = finder.findRequiredViewAsType(source, R.id.layout_location, "field 'layout_location'", LinearLayout.class);
