...
public class InterestJianliActivity_ViewBinding<T extends InterestJianliActivity> implements Unbinder {
  protected T target;

  public InterestJianliActivity_ViewBinding(T target, Finder finder, Object source) {
    this.target = target;
