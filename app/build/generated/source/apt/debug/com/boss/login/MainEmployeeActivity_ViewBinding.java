...
public class MainEmployeeActivity_ViewBinding<T extends MainEmployeeActivity> implements Unbinder {
  protected T target;

  private View view2131558521;

  public MainEmployeeActivity_ViewBinding(final T target, Finder finder, Object source) {
    this.target = target;
