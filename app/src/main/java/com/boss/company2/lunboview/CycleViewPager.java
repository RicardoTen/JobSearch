package com.boss.company2.lunboview;
...
public class CycleViewPager extends Fragment implements OnPageChangeListener {
	...
	public void setData(List<ImageView> views, Company company, ImageCycleViewListener listener) {
		setData(views, company, listener, 0);
	}
	 ...
	 *            默认显示位置
	 */
	public void setData(List<ImageView> views, Company company, ImageCycleViewListener listener, int showPosition) {
