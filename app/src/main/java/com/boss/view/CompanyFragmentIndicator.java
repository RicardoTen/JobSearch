 ...
 * @author
 */
public class CompanyFragmentIndicator extends LinearLayout implements
		OnClickListener {
	...
	private CompanyFragmentIndicator(Context context) {
		super(context);
	}

	public CompanyFragmentIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
