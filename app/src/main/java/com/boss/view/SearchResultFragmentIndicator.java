 ...
 * @author
 */
public class SearchResultFragmentIndicator extends LinearLayout implements
		OnClickListener {
	 ...
	 * Company底部指示器的文字
	 */
	private static final String TEXT[] = { "职位", "公司", "用户" };
	...
	private SearchResultFragmentIndicator(Context context) {
		super(context);
	}

	public SearchResultFragmentIndicator(Context context, AttributeSet attrs) {
		super(context, attrs);
