...
import com.boss.im.bean.AddFriendMessage;
import com.boss.im.bean.Friend;
...
public class UserInfoActivity extends ParentWithNaviActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        info = new BmobIMUserInfo(user.getObjectId(),user.getUsername(),user.getAvator());
        ImageLoaderFactory.getLoader().loadAvator(iv_avator,user.getAvator(),R.mipmap.head);
    ...
    private void sendAddFriendMessage(){
        ...
        map.put("avatar",currentUser.getAvator());//发送者的头像
