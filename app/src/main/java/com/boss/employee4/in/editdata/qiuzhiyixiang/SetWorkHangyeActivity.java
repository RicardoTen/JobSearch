...
public class SetWorkHangyeActivity extends BaseActivity implements OnClickListener{
	@Override
	...
	private void iniyListView1() {
		...
		for (int i = 0; i < BossConstants.HANG_YE.length; i++) {
			...
			workSkill.setSkill(BossConstants.HANG_YE[i]);
		...
		mGridView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				String mWorkSkill=BossConstants.HANG_YE[arg2];
