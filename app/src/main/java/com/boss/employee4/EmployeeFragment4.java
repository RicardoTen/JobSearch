...
public class EmployeeFragment4 extends Fragment implements OnClickListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View rootView = inflater
				.inflate(R.layout.fragment_employee4_employeefragment4,
						container, false);
	...
	private void initGridView1() {
		...
		data1.setData_int(postJianLiNum);
		data1.setData_string("已投递简历");
		mListShow1.add(data1);

		Show1 data2 = new Show1();
		data2.setData_int(0);
		data2.setData_string("待面试");
		...
		mGridView1.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(arg2 == 0){
					Intent intent = new Intent(getActivity(), PostJobListActivity.class);
	...
	private void queryPostJianLiNum() {
		...
		query.count(getActivity(), PostJianLi.class, new CountListener() {
			...
			public void onFailure(int i, String s) {
				Toast.makeText(getActivity(), "查询简历数目失败"+s,Toast.LENGTH_SHORT).show();
			}
		});
	}
}
