...
public class EmployeeStep1Activity extends BaseActivity implements
        OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        parentView = inflater.inflate(R.layout.activity_register_employeestep1,
    ...
    private void goStep2() {
        ...
        newUser.update(this, bmobUser.getObjectId(), new UpdateListener() {
            ...
            public void onSuccess() {
                ...
                startActivity(new Intent(EmployeeStep1Activity.this,
                        EmployeeStep2Activity.class));
            }
    ...
    public void startImageAction(Uri uri, int outputX, int outputY,
        ...
        EmployeeStep1Activity.this.startActivityForResult(intent, requestCode);
    }
        ...
        if (resultCode == Activity.RESULT_OK) {
            switch (requestCode) {
                ...
                case 3:// 裁剪头像返回
                    ...
                    if (data == null) {
                        Toast.makeText(EmployeeStep1Activity.this, "取消选择",
    ...
    private void uploadAvatar() {
		...
		/*	@Override
            ...
            public void onSuccess() {
                // bmobFile.getFileUrl()--返回的上传文件的完整地址
                updataUserAvatar(bmobFile.getFileUrl(EmployeeStep1Activity.this));
            }
    ...
    public class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent != null
                ...
                EmployeeStep1Activity.this.finish();
            }
        }
