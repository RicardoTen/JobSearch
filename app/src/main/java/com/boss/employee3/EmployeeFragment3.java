...
import com.boss.R;
import com.boss.im.adapter.ConversationAdapter;
import com.boss.im.bean.Conversation;
import com.boss.im.bean.NewFriendConversation;
import com.boss.im.bean.PrivateConversation;
import com.boss.im.db.NewFriend;
import com.boss.im.db.NewFriendManager;
import com.boss.im.event.RefreshEvent;
import com.boss.im.holder.IMutlipleItem;
import com.boss.im.holder.OnRecyclerViewListener;
import com.boss.im.ui.ParentWithNaviActivity;
import com.boss.im.ui.ParentWithNaviFragment;
import com.boss.im.ui.SearchUserActivity;
...
public class EmployeeFragment3 extends ParentWithNaviFragment {
...
/*		List<Conversation> conversitios = getConversations();
		for(int i = 0; i < conversitios.size();i++){
