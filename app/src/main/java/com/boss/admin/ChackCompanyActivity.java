...
import com.boss.R;
import com.boss.admin.adaper.PrepareCompanyAdapter;
...
public class ChackCompanyActivity extends BaseActivity{

    PrepareCompanyAdapter adapter1;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_company_list);
    ...
    private void initData() {
        ...
        adapter1 = new PrepareCompanyAdapter(this, mListShow1);
...
/*                View mItemView = view;
                ...
                Bundle bundle = new Bundle();
                bundle.putSerializable("company", (Company)parent.getItemAtPosition(position) );
                bundle.putBoolean("review", true );
                Intent intent = new Intent(ChackCompanyActivity.this, CheckCompanyInfoActivity.class);
    ...
    private void queryData(int page, final int actionType) {
        ...
        query.addWhereEqualTo("companyState", BossConstants.STATISTICS_ING);
        // 设置每页数据个数
